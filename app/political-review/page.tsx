  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <section className="mb-12 border-b-2 border-black pb-6">
          <h1 className="text-5xl md:text-6xl font-bold text-black mb-2" style={{ fontFamily: 'var(--font-oswald)' }}>
            Political Review
          </h1>
          <p className="text-lg text-gray-700" style={{ fontFamily: 'var(--font-cormorant)' }}>
        ...
        <section className="mb-16">
          <div className="flex items-center justify-between mb-8">
            <h2 className="text-3xl font-bold text-black" style={{ fontFamily: 'var(--font-oswald)' }}>Latest</h2>
            <Link href="/political-review/archive" className="text-sm text-gray-600 hover:text-black" style={{ fontFamily: 'var(--font-cormorant)' }}>
              Archive →
            </Link>
          </div>
          <div className="space-y-8">
            ...
            {[1, 2, 3, 4].map((i) => (
              <article key={i} className="border-b border-gray-300 pb-8 hover:opacity-80 transition-opacity cursor-pointer">
                <div className="flex gap-6">
                  <div className="w-40 h-40 bg-gradient-to-br from-gray-200 to-gray-300 flex-shrink-0"></div>
                  <div className="flex-1">
                    <div className="flex items-center gap-2 mb-2">
                      <span className="text-sm text-gray-600" style={{ fontFamily: 'var(--font-cormorant)' }}>Section</span>
                      <span className="text-gray-400">•</span>
                      <span className="text-sm text-gray-600" style={{ fontFamily: 'var(--font-cormorant)' }}>Author Name</span>
                      <span className="text-gray-400">•</span>
                      <span className="text-sm text-gray-600" style={{ fontFamily: 'var(--font-cormorant)' }}>Nov 12, 2025</span>
                    </div>
                    <h3 className="text-2xl font-bold text-black mb-3 hover:text-[#8C1515] transition-colors" style={{ fontFamily: 'var(--font-oswald)' }}>
                      Article Title Goes Here
                    </h3>
                    <p className="text-gray-700 leading-relaxed" style={{ fontFamily: 'var(--font-cormorant)' }}>
        ...
        <section className="mb-16">
          <h2 className="text-3xl font-bold text-black mb-8" style={{ fontFamily: 'var(--font-oswald)' }}>Featured</h2>
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {/* Placeholder for featured articles */}
            {[1, 2, 3, 4, 5, 6].map((i) => (
              <article key={i} className="bg-white border border-gray-300 hover:border-black transition-colors cursor-pointer">
        ...
        {/* Section Categories */}
        <section className="mb-16">
          <h2 className="text-3xl font-bold text-black mb-8" style={{ fontFamily: 'var(--font-oswald)' }}>Sections</h2>
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {sections.map((section) => (
              <Link
                ...
                className="group"
              >
                <div className="border-2 border-black p-8 h-full hover:bg-black hover:text-white transition-all">
                  <h3 className="text-2xl font-bold mb-3" style={{ fontFamily: 'var(--font-oswald)' }}>{section.name}</h3>
                  <p className="mb-4 leading-relaxed" style={{ fontFamily: 'var(--font-cormorant)' }}>{section.description}</p>
                  <span className="text-sm font-medium group-hover:underline" style={{ fontFamily: 'var(--font-cormorant)' }}>
                    Read More →
                  </span>
                </div>
              </Link>
        ...
        <section className="mb-16">
          <div className="flex items-center justify-between mb-8">
            <h2 className="text-3xl font-bold text-black" style={{ fontFamily: 'var(--font-oswald)' }}>Column</h2>
            <Link href="/political-review/column" className="text-sm text-gray-600 hover:text-black" style={{ fontFamily: 'var(--font-cormorant)' }}>
              Read More in Column →
            </Link>
          </div>
          <div className="grid md:grid-cols-2 gap-6">
            {[1, 2].map((i) => (
              <article key={i} className="border border-gray-300 p-6 hover:border-black transition-colors cursor-pointer">
                <div className="flex items-center gap-2 mb-3">
                  <span className="text-sm text-gray-600" style={{ fontFamily: 'var(--font-cormorant)' }}>Author Name</span>
                  <span className="text-gray-400">•</span>
                  <span className="text-sm text-gray-600" style={{ fontFamily: 'var(--font-cormorant)' }}>Date</span>
                </div>
                <h3 className="text-xl font-bold text-black mb-2" style={{ fontFamily: 'var(--font-oswald)' }}>
                  Column Title Goes Here
                </h3>
                <p className="text-gray-700 text-sm line-clamp-3" style={{ fontFamily: 'var(--font-cormorant)' }}>
        ...
        {/* Call to Action */}
        <section className="bg-gray-50 border-2 border-black p-12 text-center">
